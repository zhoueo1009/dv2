...
Please view the interactive visualization on [here]([https://public.tableau.com/app/profile/yiou3293/viz/dv2_16483948171100/Story1])
...
3|Add calculated area. Partitioned the data into 7 groups according to the conditions  
'IF SUM([Total Trips])>1000000 THEN ">1,000,000"
ELSEIF SUM([Total Trips])>500000 THEN "500,001-1,000,000"
ELSEIF SUM([Total Trips])>100000 THEN "100,001-500,000"
ELSEIF SUM([Total Trips])>50000 THEN "50,001-100,000"
ELSEIF SUM([Total Trips])>10000 THEN "10,001-50,000"
ELSEIF SUM([Total Trips])>5000 THEN "5,001-10,000"
ELSE "<5,000"|![](images/11.1.png)|
